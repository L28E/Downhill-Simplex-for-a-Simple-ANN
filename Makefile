...
algo_test: algo_test.o vertex.o downhill_simplex.o
	$(CC) -o algo_test algo_test.o vertex.o downhill_simplex.o
...
debug: algo_test_debug.o vertex_debug.o downhill_simplex_debug.o 
	$(CC) -o algo_test_debug algo_test.o vertex_debug.o downhill_simplex_debug.o -g
